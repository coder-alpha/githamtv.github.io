...
ADDON=xbmcaddon.Addon(id='plugin.program.podgodwizard')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/HQa2FSId4qgLWDd1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("podgod Wizard","Downloading ",'', 'Please Wait')
