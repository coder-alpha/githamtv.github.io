...
__settings__ = xbmcaddon.Addon(id='plugin.video.PGLiveTV')
__icon__ = xbmcaddon.Addon(id='plugin.video.PGLiveTV').getAddonInfo('icon')
...
class Paths:
    ...
    catchersRepo = 'https://github.com/MusterGit/PGLiveTV-catchers/tree/master/catchers'
    modulesRepo = 'https://github.com/MusterGit/PGLiveTV-modules/tree/master/modules'
